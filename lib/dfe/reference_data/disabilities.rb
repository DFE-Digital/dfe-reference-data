      ...
      DISABILITIES = DfE::ReferenceData::HardcodedReferenceList.new(
        {
          '797c0994-f339-4fbf-8b52-f8c718979b76' =>
          {
            ...
            match_synonyms: ['A specific learning difficulty such as dyslexia, dyspraxia or AD(H)D'],
            hesa_itt_code: '51'
          },
          'c88582ab-c659-4e7d-8379-24ada05152e1' =>
          {
            ...
            match_synonyms: ["A social/communication impairment such as Asperger's syndrome/other autistic spectrum disorder"],
            hesa_itt_code: '53'
          },
          'aaff1d81-77f8-4c17-bdd8-f75034581adb' =>
          {
            ...
            match_synonyms: ['A long standing illness or health condition such as cancer,  HIV, diabetes, chronic heart disease, or epilepsy'],
            hesa_itt_code: '54'
          },
          ...
          'fb80c6bc-630c-456f-9352-0acef3a426f4' =>
          {
            ...
            match_synonyms: ['A physical impairment or mobility issues, such as difficulty using arms or using a wheelchair or crutches'],
            hesa_itt_code: '56'
          },
          '790b6e4e-ae70-4119-8bee-6e9f165a473b' =>
          {
            name: 'D/deaf or have a hearing impairment',
            match_synonyms: ['Deaf or a serious hearing impairment'],
            hesa_itt_code: '57'
          },
          'a0cca0a8-0917-4900-a89a-3435b9c1c492' =>
          {
            name: 'Blind or have a visual impairment uncorrected by glasses',
            match_synonyms: ['Blind or a serious visual impairment uncorrected by glasses'],
            hesa_itt_code: '58'
          },
          ...
          'ca8ba870-2b29-4ef5-b8e6-81aa346c3fb8' =>
          {
            ...
            match_synonyms: ['A disability, impairment or medical condition that is not listed above'],
            hesa_itt_code: '96'
          },

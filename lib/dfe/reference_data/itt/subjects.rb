module DfE
  module ReferenceData
    module ITT
      ...
      # publish_category where a simple correspondance between a category and a
      # subject from publish exists - but this is just for information, the
      # publish_category values in SUBJECTS are the canonical ones.

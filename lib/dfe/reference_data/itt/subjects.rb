module DfE
  module ReferenceData
    module ITT
      ...
      # Formerly "allocation subjects" from register

      # Merged with publish subjects from the API endpoint https://api.publish-teacher-training-courses.service.gov.uk/api/public/v1/subjects

      # FIXME: publish codes won't stay in here - push them down to individual SUBJECTS entries as there are several codes mentioned in publish_subjects_by_incentive.sexpr that don't just map to a CATEGORIES entry neatly

...
periodicTableReferenceList = HardcodedReferenceList.new(
  {
    'H' => { id: 'H', atomic_number: 1, name: 'Hydrogen', atomic_mass: 1.007, number_of_neutrons: 0,
    ...
    'He' => { id: 'He', atomic_number: 2, name: 'Helium', atomic_mass: 4.002, number_of_neutrons: 2,
    ...
    'Li' => { id: 'Li', atomic_number: 3, name: 'Lithium', atomic_mass: 6.941, number_of_neutrons: 4,
    ...
    'Be' => { id: 'Be', atomic_number: 4, name: 'Beryllium', atomic_mass: 9.012, number_of_neutrons: 5,
    ...
    'B' => { id: 'B', atomic_number: 5, name: 'Boron', atomic_mass: 10.811, number_of_neutrons: 6,
    ...
    'C' => { id: 'C', atomic_number: 6, name: 'Carbon', atomic_mass: 12.011, number_of_neutrons: 6,
    ...
    'N' => { id: 'N', atomic_number: 7, name: 'Nitrogen', atomic_mass: 14.007, number_of_neutrons: 7,
    ...
    'O' => { id: 'O', atomic_number: 8, name: 'Oxygen', atomic_mass: 15.999, number_of_neutrons: 8,
    ...
    'F' => { id: 'F', atomic_number: 9, name: 'Fluorine', atomic_mass: 18.998, number_of_neutrons: 10,
    ...
    'Ne' => { id: 'Ne', atomic_number: 10, name: 'Neon', atomic_mass: 20.18, number_of_neutrons: 10,
    ...
    'Na' => { id: 'Na', atomic_number: 11, name: 'Sodium', atomic_mass: 22.99, number_of_neutrons: 12,
    ...
    'Mg' => { id: 'Mg', atomic_number: 12, name: 'Magnesium', atomic_mass: 24.305, number_of_neutrons: 12,
    ...
    'Al' => { id: 'Al', atomic_number: 13, name: 'Aluminum', atomic_mass: 26.982, number_of_neutrons: 14,
    ...
    'Si' => { id: 'Si', atomic_number: 14, name: 'Silicon', atomic_mass: 28.086, number_of_neutrons: 14,
    ...
    'P' => { id: 'P', atomic_number: 15, name: 'Phosphorus', atomic_mass: 30.974, number_of_neutrons: 16,
    ...
    'S' => { id: 'S', atomic_number: 16, name: 'Sulfur', atomic_mass: 32.065, number_of_neutrons: 16,
    ...
    'Cl' => { id: 'Cl', atomic_number: 17, name: 'Chlorine', atomic_mass: 35.453, number_of_neutrons: 18,
    ...
    'Ar' => { id: 'Ar', atomic_number: 18, name: 'Argon', atomic_mass: 39.948, number_of_neutrons: 22,
    ...
    'K' => { id: 'K', atomic_number: 19, name: 'Potassium', atomic_mass: 39.098, number_of_neutrons: 20,
    ...
    'Ca' => { id: 'Ca', atomic_number: 20, name: 'Calcium', atomic_mass: 40.078, number_of_neutrons: 20,
    ...
    'Sc' => { id: 'Sc', atomic_number: 21, name: 'Scandium', atomic_mass: 44.956, number_of_neutrons: 24,
    ...
    'Ti' => { id: 'Ti', atomic_number: 22, name: 'Titanium', atomic_mass: 47.867, number_of_neutrons: 26,
    ...
    'V' => { id: 'V', atomic_number: 23, name: 'Vanadium', atomic_mass: 50.942, number_of_neutrons: 28,
    ...
    'Cr' => { id: 'Cr', atomic_number: 24, name: 'Chromium', atomic_mass: 51.996, number_of_neutrons: 28,
    ...
    'Mn' => { id: 'Mn', atomic_number: 25, name: 'Manganese', atomic_mass: 54.938, number_of_neutrons: 30,
    ...
    'Fe' => { id: 'Fe', atomic_number: 26, name: 'Iron', atomic_mass: 55.845, number_of_neutrons: 30,
              ...
              number_of_isotopes: 10, discoverer: 'Prehistoric', year: nil,
              specific_heat: 0.449, number_of_shells: 4, valence: nil },
    'Co' => { id: 'Co', atomic_number: 27, name: 'Cobalt', atomic_mass: 58.933, number_of_neutrons: 32,
    ...
    'Ni' => { id: 'Ni', atomic_number: 28, name: 'Nickel', atomic_mass: 58.693, number_of_neutrons: 31,
    ...
    'Cu' => { id: 'Cu', atomic_number: 29, name: 'Copper', atomic_mass: 63.546, number_of_neutrons: 35,
    ...
    'Zn' => { id: 'Zn', atomic_number: 30, name: 'Zinc', atomic_mass: 65.38, number_of_neutrons: 35,
    ...
    'Ga' => { id: 'Ga', atomic_number: 31, name: 'Gallium', atomic_mass: 69.723, number_of_neutrons: 39,
    ...
    'Ge' => { id: 'Ge', atomic_number: 32, name: 'Germanium', atomic_mass: 72.64, number_of_neutrons: 41,
    ...
    'As' => { id: 'As', atomic_number: 33, name: 'Arsenic', atomic_mass: 74.922, number_of_neutrons: 42,
    ...
    'Se' => { id: 'Se', atomic_number: 34, name: 'Selenium', atomic_mass: 78.96, number_of_neutrons: 45,
    ...
    'Br' => { id: 'Br', atomic_number: 35, name: 'Bromine', atomic_mass: 79.904, number_of_neutrons: 45,
    ...
    'Kr' => { id: 'Kr', atomic_number: 36, name: 'Krypton', atomic_mass: 83.798, number_of_neutrons: 48,
    ...
    'Rb' => { id: 'Rb', atomic_number: 37, name: 'Rubidium', atomic_mass: 85.468, number_of_neutrons: 48,
    ...
    'Sr' => { id: 'Sr', atomic_number: 38, name: 'Strontium', atomic_mass: 87.62, number_of_neutrons: 50,
    ...
    'Y' => { id: 'Y', atomic_number: 39, name: 'Yttrium', atomic_mass: 88.906, number_of_neutrons: 50,
    ...
    'Zr' => { id: 'Zr', atomic_number: 40, name: 'Zirconium', atomic_mass: 91.224, number_of_neutrons: 51,
    ...
    'Nb' => { id: 'Nb', atomic_number: 41, name: 'Niobium', atomic_mass: 92.906, number_of_neutrons: 52,
    ...
    'Mo' => { id: 'Mo', atomic_number: 42, name: 'Molybdenum', atomic_mass: 95.96, number_of_neutrons: 54,
    ...
    'Tc' => { id: 'Tc', atomic_number: 43, name: 'Technetium', atomic_mass: 98, number_of_neutrons: 55,
    ...
    'Ru' => { id: 'Ru', atomic_number: 44, name: 'Ruthenium', atomic_mass: 101.07, number_of_neutrons: 57,
    ...
    'Rh' => { id: 'Rh', atomic_number: 45, name: 'Rhodium', atomic_mass: 102.906, number_of_neutrons: 58,
    ...
    'Pd' => { id: 'Pd', atomic_number: 46, name: 'Palladium', atomic_mass: 106.42, number_of_neutrons: 60,
    ...
    'Ag' => { id: 'Ag', atomic_number: 47, name: 'Silver', atomic_mass: 107.868, number_of_neutrons: 61,
    ...
    'Cd' => { id: 'Cd', atomic_number: 48, name: 'Cadmium', atomic_mass: 112.411, number_of_neutrons: 64,
    ...
    'In' => { id: 'In', atomic_number: 49, name: 'Indium', atomic_mass: 114.818, number_of_neutrons: 66,
    ...
    'Sn' => { id: 'Sn', atomic_number: 50, name: 'Tin', atomic_mass: 118.71, number_of_neutrons: 69,
    ...
    'Sb' => { id: 'Sb', atomic_number: 51, name: 'Antimony', atomic_mass: 121.76, number_of_neutrons: 71,
    ...
    'Te' => { id: 'Te', atomic_number: 52, name: 'Tellurium', atomic_mass: 127.6, number_of_neutrons: 76,
    ...
    'I' => { id: 'I', atomic_number: 53, name: 'Iodine', atomic_mass: 126.904, number_of_neutrons: 74,
    ...
    'Xe' => { id: 'Xe', atomic_number: 54, name: 'Xenon', atomic_mass: 131.293, number_of_neutrons: 77,
    ...
    'Cs' => { id: 'Cs', atomic_number: 55, name: 'Cesium', atomic_mass: 132.905, number_of_neutrons: 78,
    ...
    'Ba' => { id: 'Ba', atomic_number: 56, name: 'Barium', atomic_mass: 137.327, number_of_neutrons: 81,
    ...
    'La' => { id: 'La', atomic_number: 57, name: 'Lanthanum', atomic_mass: 138.905, number_of_neutrons: 82,
    ...
    'Ce' => { id: 'Ce', atomic_number: 58, name: 'Cerium', atomic_mass: 140.116, number_of_neutrons: 82,
    ...
    'Pr' => { id: 'Pr', atomic_number: 59, name: 'Praseodymium', atomic_mass: 140.908, number_of_neutrons: 82,
    ...
    'Nd' => { id: 'Nd', atomic_number: 60, name: 'Neodymium', atomic_mass: 144.242, number_of_neutrons: 84,
    ...
    'Pm' => { id: 'Pm', atomic_number: 61, name: 'Promethium', atomic_mass: 145, number_of_neutrons: 84,
    ...
    'Sm' => { id: 'Sm', atomic_number: 62, name: 'Samarium', atomic_mass: 150.36, number_of_neutrons: 88,
    ...
    'Eu' => { id: 'Eu', atomic_number: 63, name: 'Europium', atomic_mass: 151.964, number_of_neutrons: 89,
    ...
    'Gd' => { id: 'Gd', atomic_number: 64, name: 'Gadolinium', atomic_mass: 157.25, number_of_neutrons: 93,
    ...
    'Tb' => { id: 'Tb', atomic_number: 65, name: 'Terbium', atomic_mass: 158.925, number_of_neutrons: 94,
              ...
              specific_heat: 0.182, number_of_shells: 6, valence: nil },
    'Dy' => { id: 'Dy', atomic_number: 66, name: 'Dysprosium', atomic_mass: 162.5, number_of_neutrons: 97,
    ...
    'Ho' => { id: 'Ho', atomic_number: 67, name: 'Holmium', atomic_mass: 164.93, number_of_neutrons: 98,
    ...
    'Er' => { id: 'Er', atomic_number: 68, name: 'Erbium', atomic_mass: 167.259, number_of_neutrons: 99,
    ...
    'Tm' => { id: 'Tm', atomic_number: 69, name: 'Thulium', atomic_mass: 168.934, number_of_neutrons: 100,
    ...
    'Yb' => { id: 'Yb', atomic_number: 70, name: 'Ytterbium', atomic_mass: 173.054, number_of_neutrons: 103,
    ...
    'Lu' => { id: 'Lu', atomic_number: 71, name: 'Lutetium', atomic_mass: 174.967, number_of_neutrons: 104,
    ...
    'Hf' => { id: 'Hf', atomic_number: 72, name: 'Hafnium', atomic_mass: 178.49, number_of_neutrons: 106,
    ...
    'Ta' => { id: 'Ta', atomic_number: 73, name: 'Tantalum', atomic_mass: 180.948, number_of_neutrons: 108,
    ...
    'W' => { id: 'W', atomic_number: 74, name: 'Wolfram', atomic_mass: 183.84, number_of_neutrons: 110,
    ...
    'Re' => { id: 'Re', atomic_number: 75, name: 'Rhenium', atomic_mass: 186.207, number_of_neutrons: 111,
    ...
    'Os' => { id: 'Os', atomic_number: 76, name: 'Osmium', atomic_mass: 190.23, number_of_neutrons: 114,
    ...
    'Ir' => { id: 'Ir', atomic_number: 77, name: 'Iridium', atomic_mass: 192.217, number_of_neutrons: 115,
    ...
    'Pt' => { id: 'Pt', atomic_number: 78, name: 'Platinum', atomic_mass: 195.084, number_of_neutrons: 117,
    ...
    'Au' => { id: 'Au', atomic_number: 79, name: 'Gold', atomic_mass: 196.967, number_of_neutrons: 118,
    ...
    'Hg' => { id: 'Hg', atomic_number: 80, name: 'Mercury', atomic_mass: 200.59, number_of_neutrons: 121,
              ...
              specific_heat: 0.14, number_of_shells: 6, valence: nil },
    'Tl' => { id: 'Tl', atomic_number: 81, name: 'Thallium', atomic_mass: 204.383, number_of_neutrons: 123,
    ...
    'Pb' => { id: 'Pb', atomic_number: 82, name: 'Lead', atomic_mass: 207.2, number_of_neutrons: 125,
    ...
    'Bi' => { id: 'Bi', atomic_number: 83, name: 'Bismuth', atomic_mass: 208.98, number_of_neutrons: 126,
    ...
    'Po' => { id: 'Po', atomic_number: 84, name: 'Polonium', atomic_mass: 210, number_of_neutrons: 126,
    ...
    'At' => { id: 'At', atomic_number: 85, name: 'Astatine', atomic_mass: 210, number_of_neutrons: 125,
    ...
    'Rn' => { id: 'Rn', atomic_number: 86, name: 'Radon', atomic_mass: 222, number_of_neutrons: 136,
    ...
    'Fr' => { id: 'Fr', atomic_number: 87, name: 'Francium', atomic_mass: 223, number_of_neutrons: 136,
    ...
    'Ra' => { id: 'Ra', atomic_number: 88, name: 'Radium', atomic_mass: 226, number_of_neutrons: 138,
    ...
    'Ac' => { id: 'Ac', atomic_number: 89, name: 'Actinium', atomic_mass: 227, number_of_neutrons: 138,
    ...
    'Th' => { id: 'Th', atomic_number: 90, name: 'Thorium', atomic_mass: 232.038, number_of_neutrons: 142,
    ...
    'Pa' => { id: 'Pa', atomic_number: 91, name: 'Protactinium', atomic_mass: 231.036, number_of_neutrons: 140,
    ...
    'U' => { id: 'U', atomic_number: 92, name: 'Uranium', atomic_mass: 238.029, number_of_neutrons: 146,
    ...
    'Np' => { id: 'Np', atomic_number: 93, name: 'Neptunium', atomic_mass: 237, number_of_neutrons: 144,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Pu' => { id: 'Pu', atomic_number: 94, name: 'Plutonium', atomic_mass: 244, number_of_neutrons: 150,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Am' => { id: 'Am', atomic_number: 95, name: 'Americium', atomic_mass: 243, number_of_neutrons: 148,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Cm' => { id: 'Cm', atomic_number: 96, name: 'Curium', atomic_mass: 247, number_of_neutrons: 151,
              ...
              number_of_isotopes: 133, discoverer: 'Seaborg et al.', year: 1944,
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Bk' => { id: 'Bk', atomic_number: 97, name: 'Berkelium', atomic_mass: 247, number_of_neutrons: 150,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Cf' => { id: 'Cf', atomic_number: 98, name: 'Californium', atomic_mass: 251, number_of_neutrons: 153,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Es' => { id: 'Es', atomic_number: 99, name: 'Einsteinium', atomic_mass: 252, number_of_neutrons: 153,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Fm' => { id: 'Fm', atomic_number: 100, name: 'Fermium', atomic_mass: 257, number_of_neutrons: 157,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Md' => { id: 'Md', atomic_number: 101, name: 'Mendelevium', atomic_mass: 258, number_of_neutrons: 157,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'No' => { id: 'No', atomic_number: 102, name: 'Nobelium', atomic_mass: 259, number_of_neutrons: 157,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Lr' => { id: 'Lr', atomic_number: 103, name: 'Lawrencium', atomic_mass: 262, number_of_neutrons: 159,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Rf' => { id: 'Rf', atomic_number: 104, name: 'Rutherfordium', atomic_mass: 261, number_of_neutrons: 157,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Db' => { id: 'Db', atomic_number: 105, name: 'Dubnium', atomic_mass: 262, number_of_neutrons: 157,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Sg' => { id: 'Sg', atomic_number: 106, name: 'Seaborgium', atomic_mass: 266, number_of_neutrons: 160,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Bh' => { id: 'Bh', atomic_number: 107, name: 'Bohrium', atomic_mass: 264, number_of_neutrons: 157,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Hs' => { id: 'Hs', atomic_number: 108, name: 'Hassium', atomic_mass: 267, number_of_neutrons: 159,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Mt' => { id: 'Mt', atomic_number: 109, name: 'Meitnerium', atomic_mass: 268, number_of_neutrons: 159,
              ...
              specific_heat: nil, number_of_shells: 7, valence: nil },
    'Ds ' => { id: 'Ds ', atomic_number: 110, name: 'Darmstadtium ', atomic_mass: 271, number_of_neutrons: 161,
               ...
               specific_heat: nil, number_of_shells: 7, valence: nil },
    'Rg ' => { id: 'Rg ', atomic_number: 111, name: 'Roentgenium ', atomic_mass: 272, number_of_neutrons: 161,
               ...
               number_of_isotopes: nil, discoverer: nil, year: 1994,
               specific_heat: nil, number_of_shells: 7, valence: nil },
    'Cn ' => { id: 'Cn ', atomic_number: 112, name: 'Copernicium ', atomic_mass: 285, number_of_neutrons: 173,
               ...
               specific_heat: nil, number_of_shells: 7, valence: nil },
    'Nh' => { id: 'Nh', atomic_number: 113, name: 'Nihonium', atomic_mass: 284, number_of_neutrons: 171,
    ...
    'Fl' => { id: 'Fl', atomic_number: 114, name: 'Flerovium', atomic_mass: 289, number_of_neutrons: 175,
    ...
    'Mc' => { id: 'Mc', atomic_number: 115, name: 'Moscovium', atomic_mass: 288, number_of_neutrons: 173,
    ...
    'Lv' => { id: 'Lv', atomic_number: 116, name: 'Livermorium', atomic_mass: 292, number_of_neutrons: 176,
    ...
    'Ts' => { id: 'Ts', atomic_number: 117, name: 'Tennessine', atomic_mass: 295, number_of_neutrons: 178,
    ...
    'Og' => { id: 'Og', atomic_number: 118, name: 'Oganesson', atomic_mass: 294, number_of_neutrons: 176,
